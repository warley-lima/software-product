...
public class AdressUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adress_update);
        ...
        iptLytName =  findViewById(R.id.input_layout_name_update_adress);
        iptLytCep = findViewById(R.id.input_layout_update_cep);
        iptLytNumber =  findViewById(R.id.input_layout_number_update_adress);
       // TextInputLayout iptLytComp = findViewById(R.id.input_layout_complemento_update_adress);
        iptLytAdress =  findViewById(R.id.input_layout_adress_update_adress);
        iptLytBairro=  findViewById(R.id.input_layout_bairro_update_adress);
        iptLytCity=  findViewById(R.id.input_layout_cidade_update_adress);
        txtName =  findViewById(R.id.input_name_update_adress);
        txtCep =  findViewById(R.id.input_update_cep);
        txtNumber = findViewById(R.id.input_number_update_adress);
        txtComp = findViewById(R.id.input_complemento_update_adress);
        txtAdress = findViewById(R.id.input_adress_update_adress);
        txtBairro = findViewById(R.id.input_bairro_update_adress);
        txtCity = findViewById(R.id.input_cidade_update_adress);
        Button btnUpdate = findViewById(R.id.btn_cadastrar_update_adress);
        Button btnRemove = findViewById(R.id.btn_remove_adress);
        ...
        idAdress = getIntent().getIntExtra("idAdress", 0);
    ...
    private void setupHeaderNavigation(Toolbar toolbar) {
        NavigationView navigationView =  findViewById(R.id.nav_adress_up_view);
        mDrawerLayout = findViewById(R.id.drawer_adress_up);
    ...
    private void removeAdress(){
        adressRepository = new AdressRepository(getApplicationContext());
        Adress o = new Adress();
        o.setIdAdress(idAdress);
        if (adressRepository.delete(o) > 0){
            clearTexts();
            spinner.setVisibility(View.INVISIBLE);
            Intent myIntent = new Intent(getApplicationContext(), AdressListActivity.class);
            startActivity(myIntent);
        }else{
            Toast.makeText(getApplicationContext(), "Não foi possível remover o endereço!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private boolean submitForm() {
        ...
        try{
            ...
            adressRepository = new AdressRepository(getApplicationContext());
            Adress o = new Adress();
            /*o.setAdress(txtAdress.getText().toString().trim());
            o.setCep(txtCep.getText().toString().trim());
            o.setNumber(txtNumber.getText().toString().trim());
            o.setBairro(txtBairro.getText().toString().trim());
            o.setCity(txtCity.getText().toString().trim());
            o.setComplement(txtComp.getText().toString().trim());
            o.setName(txtName.getText().toString().trim());
            o.setIdAdress(idAdress);
            int idOrder = adressRepository.update(o);
            ...
            if (latLng != null){
                ...
                o.setLatitude("");
                o.setLongitude("");
                adressRepository.insert(o);
                return true;
            }
        }
        catch (Exception e){
            Toast.makeText(getApplicationContext(), "Falha ao editar o Endereço!".concat(e.toString()), Toast.LENGTH_SHORT).show();
            return false;
        }
    }

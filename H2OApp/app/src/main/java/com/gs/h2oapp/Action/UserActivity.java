...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarTitle.setText("Adicionar Perfil");
        setupHeaderNavigation(toolbar);
        if(null == cartBusiness){
            cartBusiness = new CarrinhoBusinessImp();
        }
        iptLytName =  findViewById(R.id.input_layout_name_user);
        iptLytFone = findViewById(R.id.input_layout_fone_user);
        txtName =  findViewById(R.id.input_name_user);
        txtFone =  findViewById(R.id.input_fone_user);
        Button btnSignUp = findViewById(R.id.btn_cadastrar_user);
    ...
    private void setupHeaderNavigation(Toolbar toolbar) {
        ...
        mDrawerLayout = findViewById(R.id.drawer_user_ad);
